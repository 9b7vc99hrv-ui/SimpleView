...
namespace BasicDemo
{
    public partial class Form1 : Form
    {
        ...
        STC_DataSet m_DevHandleThird = IntPtr.Zero;
        STC_DataSet m_DevHandleFourth = IntPtr.Zero;
        ...
        private void DeviceListAcq()
        {
            ...
            for (int i = 0; i < m_nDevNum; i++)
            {
                ...
                cbDeviceList3.Items.Add("DEV:" + "Name:" + strModelName + " " + "IP:" + strCurrentIp + " " + "SerialNum:" + strSerialNumber);
                cbDeviceList4.Items.Add("DEV:" + "Name:" + strModelName + " " + "IP:" + strCurrentIp + " " + "SerialNum:" + strSerialNumber);
            }
            ...
            if (m_nDevNum != 0)
            {
                ...
                cbDeviceList3.SelectedIndex = 0;
                cbDeviceList4.SelectedIndex = 0;
            }
        ...
        private void bnOpen_Click(object sender, EventArgs e)
        {
            ...
            nRet = Mv3dLpSDK.MV3D_LP_OpenDeviceBySN(ref m_DevHandleThird, m_stVector[cbDeviceList3.SelectedIndex].chSerialNumber);
            if ((int)Mv3dLpSDK.MV3D_LP_OK != nRet)
            {
                ShowErrorMsg("Open Device 3 Failed ", nRet);
                return;
            }

            nRet = Mv3dLpSDK.MV3D_LP_OpenDeviceBySN(ref m_DevHandleFourth, m_stVector[cbDeviceList4.SelectedIndex].chSerialNumber);
            if ((int)Mv3dLpSDK.MV3D_LP_OK != nRet)
            {
                ShowErrorMsg("Open Device 4 Failed ", nRet);
                return;
            }
            ...
            nRet = Mv3dLpSDK.MV3D_LP_SetParam(m_DevHandleThird, "ImageMode", pstValue);
            if (Mv3dLpSDK.MV3D_LP_OK != nRet)
            {
                ShowErrorMsg("SetParam ImageMode failed! error code:", nRet);
                return;
            ...
            nRet = Mv3dLpSDK.MV3D_LP_SetParam(m_DevHandleFourth, "ImageMode", pstValue);
            if (Mv3dLpSDK.MV3D_LP_OK != nRet)
            {
                ShowErrorMsg("SetParam ImageMode failed! error code:", nRet);
                return;
        ...
        public void ReceiveThreadProcess()
        {
            ...
            while (this.m_bGrabbing)
            {
                ...
                nRet = Mv3dLpSDK.MV3D_LP_GetImage(m_DevHandleThird, stImageDataVector[2], 10000);
                if (nRet == (int)Mv3dLpSDK.MV3D_LP_OK)
                {
                    nCount = nCount + 1;
                }
                ...
                nRet = Mv3dLpSDK.MV3D_LP_GetImage(m_DevHandleFourth, stImageDataVector[3], 10000);
                if (nRet == (int)Mv3dLpSDK.MV3D_LP_OK)
                {
                    nCount = nCount + 1;
                }
                ...
                if(nCount == 4)
                {
                    MV3D_LP_IMAGE_DATA stPointCloudData = new MV3D_LP_IMAGE_DATA(); ;
                    nRet = Mv3dLpSDK.MV3D_LP_MapDepthToPointCloudRound(stImageDataVector[0], (uint)nCount, stPointCloudData);
                    if ((int)Mv3dLpSDK.MV3D_LP_OK != nRet)
                    {
                        throw new ArgumentException(nRet.ToString());
                    }

                    nRet = DisplayImage(stPointCloudData);
                    if ((int)Mv3dLpSDK.MV3D_LP_OK != nRet)
                    {
                        throw new ArgumentException(nRet.ToString());
                    }
        ...
        private void bnStartGrab_Click(object sender, EventArgs e)
        {
         // 标志位置位true | Set Flag True
            ...
            nRet = Mv3dLpSDK.MV3D_LP_StartMeasure(m_DevHandleThird);
            if ((int)Mv3dLpSDK.MV3D_LP_OK != nRet)
            {
                m_bGrabbing = false;
                m_hReceiveThread.Join();
            ...
            nRet = Mv3dLpSDK.MV3D_LP_StartMeasure(m_DevHandleFourth);
            if ((int)Mv3dLpSDK.MV3D_LP_OK != nRet)
            {
                m_bGrabbing = false;
                m_hReceiveThread.Join();
        ...
        private void bnStopGrab_Click(object sender, EventArgs e)
        {
            ...
            nRet = Mv3dLpSDK.MV3D_LP_StopMeasure(m_DevHandleThird);
            nRet = Mv3dLpSDK.MV3D_LP_StopMeasure(m_DevHandleFourth);
