...
namespace BasicDemo
{
    public partial class Form1 : Form
    {
        public class ImageDataCallBackHandle : ImageDataCallBack
        {
            ...
            public ImageDataCallBackHandle(Form1 form)
            {
                this.form = form;
            }
            public override void run(MV3D_LP_IMAGE_DATA pstImageData)
            {
                if (this.form.m_bGrabbing == false)
                {
                    return;
                }

                int nRet = (int)Mv3dLpSDK.MV3D_LP_OK;
                nRet = form.DisplayImage(pstImageData);
        ...
        private void bnClose_Click(object sender, EventArgs e)
        {
            ...
            pImageDataCallBack.UnRegister(m_DevHandle);
        ...
        private int DisplayImage(MV3D_LP_IMAGE_DATA pstImage)
        {
...

            {
                ...
                m_stImageInfo.pIntensityData = pstImage.pIntensityData;
        ...
        private void bnSaveHibag_Click(object sender, EventArgs e)
        {
            int nRet = (int)Mv3dLpSDK.MV3D_LP_OK;
            uint m_FileType = Mv3dLpSDK.FileType_HIBAG;
            ...
            ShowErrorMsg("Save Hibag image success!", 0);
        }
